...
(function (a, b) {
  ...
  var c = a.document, d = a.navigator, e = a.location, f = function () {
    ...
    var e = function (a, b) {
      ...
      v = /(mozilla)(?:.*? rv:([\w.]+))?/, w = /-([a-z])/ig, x = function (a, b) {
    ...
    var l = k.selectors = {
      ...
      filter: {
        PSEUDO: function (a, b, c, d) {
          ...
          var c = b[1], d = l.attrHandle[c] ? l.attrHandle[c](a) : a[c] != null ? a[c] : a.getAttribute(c), e = d + "",
            f = b[2], g = b[4];
  ...
  var X = / jQuery\d+="(?:\d+|null)"/g, Y = /^\s+/,
    Z = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, $ = /<([\w:]+)/, _ = /<tbody/i,
    ba = /<|&#?\w+;/, bb = /<(?:script|object|embed|option|style)/i, bc = /checked\s*(?:[^=]|=\s*.checked.)/i,
    bd = /\/(java|ecma)script/i, be = /^\s*<!(?:\[CDATA\[|\-\-)/, bf = {
    ...
    clone: function (a, b, c) {
      ...
      for (var j = 0, k; (k = a[j]) != null; j++) {
        ...
        if (typeof k == "string") if (!ba.test(k)) k = b.createTextNode(k); else {
          k = k.replace(Z, "<$1></$2>");
          var l = ($.exec(k) || ["", ""])[1].toLowerCase(), m = bf[l] || bf._default, n = m[0],
  ...
  var bn = /alpha\([^)]*\)/i, bo = /opacity=([^)]*)/, bp = /([A-Z]|^ms)/g, bq = /^-?\d+(?:px)?$/i, br = /^-?\d/,
    bs = /^[+\-]=/, bt = /[^+\-\.\de]+/g, bu = {position: "absolute", visibility: "hidden", display: "block"},
  ...
  var bB = /%20/g, bC = /\[\]$/, bD = /\r?\n/g, bE = /#.*$/, bF = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg,
    ...
    bH = /^(?:about|app|app\-storage|.+\-extension|file|widget):$/, bI = /^(?:GET|HEAD)$/, bJ = /^\/\//, bK = /\?/,
    bL = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, bM = /^(?:select|textarea)/i, bN = /\s+/,
    bO = /([?&])_=[^&]*/, bP = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, bQ = f.fn.load, bR = {}, bS = {}, bT,
    bU;
  try {
    bT = e.href
  } catch (bV) {
  ...
  "getBoundingClientRect" in c.documentElement ? f.fn.offset = function (a) {
    ...
    var h = e.body, i = cv(e), j = g.clientTop || h.clientTop || 0, k = g.clientLeft || h.clientLeft || 0,
