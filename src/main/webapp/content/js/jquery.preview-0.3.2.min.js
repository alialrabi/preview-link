...
;(function () {
  var e = function () {
    ...
    return r.format = function (r, n) {
      var s, o, l, a, h, u, c, p = 1, d = r.length, f = "", m = [];
      for (o = 0; d > o; o++) if (f = t(r[o]), "string" === f) m.push(r[o]); else if ("array" === f) {
        if (a = r[o], a[2]) for (s = n[p], l = 0; a[2].length > l; l++) {
      ...
      for (var t = e, i = [], r = [], n = 0; t;) {
        if (null !== (i = /^[^\x25]+/.exec(t))) r.push(i[0]); else if (null !== (i = /^\x25{2}/.exec(t))) r.push("%"); else {
          if (null === (i = /^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/.exec(t))) throw"[sprintf] huh?";
          if (i[2]) {
            n |= 1;
            var s = [], o = i[2], l = [];
            if (null === (l = /^([a-z_][a-z_\d]*)/i.exec(o))) throw"[sprintf] huh?";
            for (s.push(l[1]); "" !== (o = o.substring(l[0].length));) if (null !== (l = /^\.([a-z_][a-z_\d]*)/i.exec(o))) s.push(l[1]); else {
  ...
  (function (e) {
    ...
    e.fn.addInputs = function (i, r) {
      return e(this).each(function () {
        ...
        e.each(r, function (t, r) {
          ...
          var l = e('<input type="hidden"/>').attr({name: r, value: escape(s)});
          n.append(l)
        })
      })
    }
    ...
    t.prototype = {
      init: function (t, i) {
        ...
        var t = this.$elem.find(".images"), i = parseInt(t.find("li").css("width"), 10),
          r = parseInt(t.css("left"), 10), n = t.find("img").length * i;
        if (0 > e) {
        ...
        this.$elem.show();
        var e = this.$elem.data("current"), t = this.$elem.find(".images img").eq(e - 1).get(0);
        this.update(t)
      }
    ...
    i.prototype = {
      ...
      url: function (e) {
        ...
        var i = e.match(this.protocolExp), r = i ? i[0] : null;
      ...
      image: function (e, i) {
        return this.none(e) ? e : this.secure ? "https://i.embed.ly/1/display?" + t.param({key: i.key, url: e}) : e
      }
    };
    var r = new i, n = function (i, n) {
      var s = t(this), o = t.extend(!0, {}, i);
      ...
      var h = ['<div class="attributes">', '<a class="title" href="#" contenteditable=true>%(title)s</a>', '<p><a class="description" href="#" contenteditable=true>%(description)s</a></p>', '<span class="meta">', l, '<a class="provider" href="%(provider_url)s">%(provider_display)s</a>', "</span>", "</div>", '<div class="action"><a href="#" class="close">&#10005;</a></div>'].join(""),
        u = ['<div class="selector">', a, e(h, o), "</div>"].join(""), c = s.closest(n.container).find(n.wrapper).eq(0);
      ...
      container: "form",
      field: null,
      query: {wmode: "opaque", words: 30, maxwidth: 560}
    }, o = function (e, t) {
      this.init(e, t)
    };
    o.prototype = {
      $form: null, data: {}, init: function (e, i) {
