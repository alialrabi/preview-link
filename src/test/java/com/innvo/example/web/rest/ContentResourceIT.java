...
public class ContentResourceIT {
    ...
    private static final String DEFAULT_PASTEDLINK = "AAAAAAAAAA";
    private static final String UPDATED_PASTEDLINK = "BBBBBBBBBB";
    ...
    public void createContent() throws Exception {
        ...
        assertThat(testContent.getPastedlink()).isEqualTo(DEFAULT_PASTEDLINK);
    }
    ...
    public void getAllContents() throws Exception {
        ...
        restContentMockMvc.perform(get("/api/contents?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].pastedlink").value(hasItem(DEFAULT_PASTEDLINK)));
    }
    ...
    public void getContent() throws Exception {
        ...
        restContentMockMvc.perform(get("/api/contents/{id}", content.getId()))
            ...
            .andExpect(jsonPath("$.pastedlink").value(DEFAULT_PASTEDLINK));
    }
    @Test
    @Transactional
    ...
    public void updateContent() throws Exception {
        ...
        assertThat(testContent.getPastedlink()).isEqualTo(UPDATED_PASTEDLINK);
    }
